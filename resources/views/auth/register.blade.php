...
<div class="bg-surface w-full max-w-[448px] p-lg md:p-xl rounded-card shadow-[0_4px_12px_rgba(0,0,0,0.05)] border border-border">
    ...
    <div class="mb-lg">
        <h2 class="font-headline-md text-headline-md text-text-primary mb-xs font-semibold">Buat Akun Baru</h2>
    ...
    <form action="{{ route('register') }}" method="POST" class="space-y-md">
        ...
        <div>
            <label class="block font-label-md text-label-md text-text-primary mb-xs uppercase tracking-wide" for="password">Password</label>
            <div class="relative mb-2">
                ...
                <input class="w-full pl-[44px] pr-sm py-sm bg-surface border border-outline-variant rounded-[10px] focus:ring-2 focus:ring-secondary focus:border-secondary font-body-md text-body-md text-text-primary transition-shadow" id="password" name="password" placeholder="Minimal 8 karakter" required="" type="password"/>
            </div>
        </div>
        
        <div>
            <label class="block font-label-md text-label-md text-text-primary mb-xs uppercase tracking-wide" for="password_confirmation">Konfirmasi Password</label>
            <div class="relative">
                <span class="absolute inset-y-0 left-0 flex items-center pl-sm text-text-secondary">
                    <span class="material-symbols-outlined" data-icon="lock">lock</span>
                </span>
                <input class="w-full pl-[44px] pr-sm py-sm bg-surface border border-outline-variant rounded-[10px] focus:ring-2 focus:ring-secondary focus:border-secondary font-body-md text-body-md text-text-primary transition-shadow" id="password_confirmation" name="password_confirmation" placeholder="Ulangi password" required="" type="password"/>
            </div>
        </div>
        
        <x-button type="submit" variant="primary" fullWidth="true">Daftar</x-button>
    </form>
    
    <div class="mt-lg text-center">
        <a href="/login" class="font-body-md text-body-md text-primary hover:text-primary-container font-medium transition-colors">
